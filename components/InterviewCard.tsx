				...
				<div>
					...
					<div className="flex flex-row gap-5 mt-3">
						<div className="flex flex-row gap-2">
							<Image src="/calendar.svg" alt="calendar img" width={22} height={22} />
							<p>{formattedDate}</p>
						</div>
					...
					<p className="line-clamp-2 mt-5">{feedback?.finalAssessment || "You have't taken the interview yet. Take it now to improve your skills."}</p>
				</div>
